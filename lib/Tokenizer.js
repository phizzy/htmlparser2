...
Tokenizer.prototype._stateCustomTag = function(c){
	if(c === ">"){
		this._cbs.oncustomtag(this._getSection());
		this._state = TEXT;
		this._sectionStart = this._index + 1;
	}
};
...
Tokenizer.prototype.write = function(chunk){
	...
	while(this._index < this._buffer.length && this._running){
		...
		*/
         ...
         *  custom tag
         */
		else if(this._state === IN_CUSTOM_TAG){
			this._stateCustomTag(c);
		}
